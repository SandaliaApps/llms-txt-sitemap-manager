...
add_action('admin_head', function() {
    ...
    if ($screen && $screen->id === 'settings_page_llms_txt_settings') {
...
add_action('admin_footer', function() {
    ...
    if ($screen && $screen->id === 'settings_page_llms_txt_settings') {
        ...
        <script type="application/ld+json">
        {
            ...
            "url": "<?php echo esc_html(admin_url('options-general.php?page=llms_txt_settings')); ?>"
        }
        </script>
        <?php
    }
...
add_action('template_redirect', function() {
    if (get_query_var('llms_txt') == 1) {
        ...
        $allow_ai = get_option('llms_txt_allow_ai', 1);
        $allow_training = get_option('llms_txt_allow_training', 1);
